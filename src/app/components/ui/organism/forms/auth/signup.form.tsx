...
const schema = z.object({
  name: z.string().min("Full name is required"),
  email: emailSchema,
...
export const SignUpForm = memo(() => {
  ...
  const {
    ...
    const handleSocialAuthSignUp = (socialType: string) => {};

  return (
    <div id="sign_up_form_container" className="w-full h-full">
        <form id="sign_up_form" className="w-full h-full py-8 px-3 md:px-6 flex flex-col justify-start items-start space-y-8" onSubmit={handleSubmit(handleOnSubmit)}>
            <section className="w-full space-y-4">
                <h5 className="text-center capitalize font-helvetica font-semibold text-gray700 tex-lg lg:text-xl">Register
                    with</h5>
                <div
                ...
                >
                    <div
                        className="inline-flex justify-center item-center border border-gray-200 size-12 rounded-xl">
                ...
                <h6 className="text-center font-bold text-gray-600 font-helvetica">or</h6>
            </section>
            <div
                id="name_container"
